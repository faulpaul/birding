...
file = config.get('SectionGeneral', 'file')
ornithdeuser = config.get('SectionOrnithode', 'user')
...
#ornitho.de
ornithodepayload = { "login":"1", "USERNAME":ornithideuser, "REMEMBER":"ON", "PASSWORD":ornithodepass }
